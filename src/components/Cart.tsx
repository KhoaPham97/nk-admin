  ...
  if (isOpen) {
    return (
      <div className="bg-[#0000007d] w-full min-h-screen fixed left-0 top-0 z-20 overflow-y-auto">
        {checkout ? (
          <div className="max-w-[400px] w-full min-h-full bg-white absolute right-0 top-0 p-6  dark:bg-slate-600 dark:text-white">
          ...
          <div
            className="max-w-[400px] w-full min-h-full bg-white absolute right-0 top-0 p-6  dark:bg-slate-600 dark:text-white"
